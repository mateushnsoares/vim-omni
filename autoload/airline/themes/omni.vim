...
func! s:clr(fg, bg, ...)
  let l:fg = g:omni#palette[a:fg]
  let l:bg = g:omni#palette[a:bg]
...
let g:airline#themes#omni#palette = {
\   'normal': s:color_map(
\       ['bg', 'purple'],
\       ['fg', 'comment'],
\       ['fg', 'selection'],
...
if get(g:, 'airline#extensions#tabline#enabled', 0)
  let g:airline#themes#omni#palette.tabline = {
...
if exists('g:loaded_ctrlp')
  let g:airline#themes#omni#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
        \ s:clr('fg', 'selection'),
        \ s:clr('fg', 'comment'),
        \ s:clr('fg', 'purple'),
        \)
